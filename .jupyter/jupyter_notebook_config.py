...
#  Choices: any of ['sha3_512', 'md5', 'sha3_224', 'sha1', 'sha384', 'blake2s', 'sha3_384', 'sha224', 'sha512', 'sha256', 'sha3_256', 'blake2b']
#  Default: 'sha256'
...
def post_save(model, os_path, contents_manager):
    ...
    convertNotebook(os_path, f"{d}/{fname_noext}.py")

    #process(f"{d}/{fname_noext}.py")
